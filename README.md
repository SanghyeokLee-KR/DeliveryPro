...
데모 데이터는 매장 28곳(승인 25, 승인대기 3), 메뉴 184개, 주문 45건, 리뷰 35건, 회원 10명,
라이더 8명, 배달 그룹 6건입니다. 주문은 픽업중, 배차중, 배달중, 배달완료로 상태를 서로 다르게
넣어 관리자와 사장님 화면에서 각각 다른 목록이 뜨도록 했습니다. 배차 대기 주문 중 세 건은 같은
매장으로 묶어 두었습니다. 라이더 화면에서 목적지가 셋인 카드를 수락해야 방문 순서 계산이
실제로 돌아갑니다.
