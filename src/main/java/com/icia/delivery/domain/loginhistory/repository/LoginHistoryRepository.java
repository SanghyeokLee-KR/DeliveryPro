package com.icia.delivery.domain.loginhistory.repository;
...
public interface LoginHistoryRepository extends JpaRepository<LoginHistoryEntity, Long> {
     ...
     */
    @Query("SELECT new com.icia.delivery.domain.loginhistory.dto.LoginHistoryDTO(lh.hisLoginId, lh.member.mId, lh.hisLoginDate, lh.hisIpAddress, lh.hisDeviceOs, lh.hisBrowser) " +
