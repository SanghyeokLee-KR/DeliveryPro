// src/main/java/com/icia/delivery/domain/notification/controller/NotificationController.java
package com.icia.delivery.domain.notification.controller;
...
public class NotificationController {
     ...
     */
    @PostMapping
    public ResponseEntity<ApiResponse<NotificationDTO>> createNotification(@Valid @RequestBody NotificationDTO dto) {
    ...
    public ResponseEntity<ApiResponse<List<NotificationDTO>>> getNotificationsBySender(
    ...
    public ResponseEntity<ApiResponse<List<NotificationDTO>>> getNotificationsPaged(
            @PathVariable String recipientType,
            @PathVariable Long recipientId,
